...
def load_llm():
    ...
    # Uncomment the following lines to use Ollama with Llama 3.2    # llm = LLM(
...
def create_agents_and_tasks(pdf_tool):
    ...
    web_search_tool = SerperDevTool(api_key = api_key, n_results=5)  # Define it outside the try block
    # try:
    #     from firecrawl import FirecrawlApp
